...
---
![紫微斗数](/images/zwds/zwds_cover.png)
...
<a href="/downloads/紫微斗数20251227.zip" data-umami-event="紫微斗数下载（github）">紫微斗数20251227</a>

可能由于各地网络运营商对海外网站的屏蔽策略不同，有的地区能从以上链接直接下载，如以上链接无法下载，您可使用如下的腾讯微云分享链接下载

<a href="https://share.weiyun.com/ROpivxXH" data-umami-event="紫微斗数下载（腾讯微云分享）" target="_blank">腾讯微云分享链接</a>

# 更新记录

## 2025-12-27

- 🛠️修正：操作系统设置显示缩放大于100%情况下，软件界面组件显示错位的情况。
- 🛠️修正：高级筛选程序异常问题。
- ✨新增：可设置闰月视为本月还是下月的配置。
- ✨新增：软件快捷配置功能。
- 新增：实现了数据库的自动升级，新版的软件可以和之前的数据库自动匹配。
- 优化：将紫微斗数的排盘选项从json文件转到了数据库。
- 优化：程序代码结构。
- 优化：软件授权方式，通过授权文件对软件特定功能进行授权使用。
